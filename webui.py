...
# Global variables for persistent browser context
    ...
    try:
        if use_own_browser:
            if global_browser_context_ is None:
                ...
                global_browser_context_ = await global_playwright.chromium.launch_persistent_context(
            ...
            browser_context_ = global_browser_context_
        else:
